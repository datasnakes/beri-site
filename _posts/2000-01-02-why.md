...
fa-icon: info
---
_Are you a biologist or bioinformatician who desires to manage R environments, install R, and install R packages using the command-line? Help develop [beRi](https://github.com/datasnakes/beRi)! beRi is a suite of tools designed to make R analyses and projects more reproducible and easier to manage using the command-line._
<br>
<br>
### What is `beRi`?
